...
<div class="relative rounded-xl overflow-hidden border border-gray-100 dark:border-gray-700/60 bg-white dark:bg-gray-800/80 shadow-sm">
  ...
  >
    <div class="relative w-full pt-[100%] bg-gray-100 dark:bg-gray-900">
      ...
      <div class="absolute left-2 top-2 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[11px] font-medium bg-black/50 text-white border border-white/20">
      ...
      <div class="absolute right-2 top-2 inline-flex items-center gap-1 rounded-full px-2 py-0.5 text-[11px] font-semibold bg-green-500/90 text-white">
      ...
      <div class="absolute inset-x-0 bottom-0 p-3">
        <p class="text-white text-sm font-semibold leading-snug line-clamp-2 drop-shadow-sm">
          {video.title.trim()}
        </p>
      </div>
    </div>
