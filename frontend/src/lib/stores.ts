...
// Active tab: 'moves' | 'random' | 'videos' | 'tags' | 'sessions' | 'calendar' | 'settings'
export const activeTab = writable<'moves' | 'random' | 'videos' | 'tags' | 'sessions' | 'calendar' | 'settings'>('moves');
