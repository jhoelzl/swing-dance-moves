...
if ( isset($_POST['submit']) ) { 
	...
	$link->query("INSERT INTO moves (name,synonyms,description,link)	VALUES ('". $move_title ."','". $move_synonym . "', '" . $move_description . "', '" . $move_link . "')");
	$move_id = mysqli_insert_id($link); 
    ...
    <div class="container">
	    ...
	    <?php 
		    ...
		    if (isset($_POST['submit']) ) {
			     ...
			     ?>
		    <div class="alert alert-success" role="alert">Move was added!</div>
...
<form action="new.php" method="post">
  ...
  <div class="form-group">
    ...
    <input name="move_title" type="text" class="form-control" id="move_title" aria-describedby="move_title_help">
  </div>
   <div class="form-group">
    <label for="move_synonym">Synonym</label>
    <input type="text" class="form-control" name="move_synonym" id="move_synonym" aria-describedby="move_synonym_help">
   ...
   <div class="form-group">
    ...
    <textarea class="form-control" name="move_description"  id="move_description" placeholder="Detailed description for leaders" rows="3"></textarea>
  </div>
   <div class="form-group">
    <label for="move_synonym">Link</label>
    <input type="text" class="form-control" name="move_link" id="move_link" aria-describedby="move_link_help">
  ...
  <?php
	...
	while($row0 = $result0->fetch_assoc()) {
		...
		$sql = "SELECT t.tag_id, t.tag_name, t.tag_label from tags t
		left outer join tag_types tp on tp.tag_type_id = t.tag_type_id
		where t.tag_type_id = '" . $row0['tag_type_id']. "'
		order by tp.sort_order, t.tag_sort, t.tag_name";
